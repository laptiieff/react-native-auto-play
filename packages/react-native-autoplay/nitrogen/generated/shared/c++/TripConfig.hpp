...
namespace margelo::nitro::swe::iternio::reactnativeautoplay {
   ...
   */
  struct TripConfig final {
  public:
    std::string id     SWIFT_PRIVATE;
    RouteChoice routeChoice     SWIFT_PRIVATE;
  ...
  struct JSIConverter<margelo::nitro::swe::iternio::reactnativeautoplay::TripConfig> final {
    static inline margelo::nitro::swe::iternio::reactnativeautoplay::TripConfig fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::swe::iternio::reactnativeautoplay::TripConfig(
        ...
        JSIConverter<margelo::nitro::swe::iternio::reactnativeautoplay::RouteChoice>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "routeChoice")))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::swe::iternio::reactnativeautoplay::TripConfig& arg) {
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "routeChoice"), JSIConverter<margelo::nitro::swe::iternio::reactnativeautoplay::RouteChoice>::toJSI(runtime, arg.routeChoice));
      return obj;
    }
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<margelo::nitro::swe::iternio::reactnativeautoplay::RouteChoice>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "routeChoice")))) return false;
      return true;
    }
  };
